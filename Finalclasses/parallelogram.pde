class parallelogram
{
  ...
  void setpolygon(PVector start,PVector side1,PVector side2,float widthpolygon,float startzaxis)
  {
 ...
 void create()
 {
  ...
  point4 = new PVector();
      ...
      point4.x = sidea.x+sideb.x-leftbottom.x;
      point4.y = sidea.y+sideb.y-leftbottom.y;
      //println(leftbottom.y+" " +sidea.y+" " +sideb.y+" " +point4.y);
