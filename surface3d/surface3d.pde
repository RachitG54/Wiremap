...
static public void main(String args[]) {
  PApplet.main(new String[] { "--present", "surface3d" });
}
void setup(){
...
//     amplitudeindex=1;
  float val1 = sin((TWO_PI/sinewavelength)*(x_by_ind[i]+squarewavex));
  float val2 = sin((TWO_PI/sinewavelength)*(z_by_ind[i]+squarewavez))
      sineamplitude = sin((TWO_PI/sinewavelength)*(x_by_ind[i]+squarewavex));
