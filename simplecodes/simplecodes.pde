...
static public void main(String args[]) {
  PApplet.main(new String[] { "--present", "simplecodes" });
}
...
void draw() {
  ...
  {fill(0);
  rect(0,0,width,height);
  int i = (int)(random(127));
      float y_top_coord = 15+random(9);
      ...
      fill(0,255,0);                                                                    // draw a rectangle at that intersect
      ...
      y_top_coord = y_bot_coord+3+random(2);
